...
describe('Assets Service', () => {
  ...
  it('should copy an asset and return its hashed filename', () => {
    ...
    expect(fileService.copySync).toHaveBeenCalledWith(filepath, `${outputDirectory}/assets/${expectedFilename}`);
  });
  ...
  it('should copy and minify a JS asset and return its hashed filename', () => {
    ...
    expect(fileService.write).toHaveBeenCalledWith(`${outputDirectory}/assets/${expectedFilename}`, minifyService.minifyJS(file));
  });
