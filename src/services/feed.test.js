...
describe('Feed Service', () => {
  ...
  it('should build an atom file', () => {
    ...
    expect(fileService.write).toHaveBeenCalledWith(
      `${configService.get().outputDirectory}/feed.atom`,
      domService.minifyHTML(`
        ...
        <feed xml:lang="en-US" xmlns="http://www.w3.org/2005/Atom">
          ...
          <entry>
            ...
            <summary>This is an excerpt for the first post</summary>
          </entry>
          <entry>
            ...
            <summary>This is an excerpt for the second post</summary>
          </entry>
          <entry>
            ...
            <summary>Esse é um excerto para o terceiro artigo.</summary>
          </entry>
        </feed>
      `)
    );
  ...
  it('should optionally build an atom file specifying a language', () => {
    ...
    expect(fileService.write).toHaveBeenCalledWith(
      `${configService.get().outputDirectory}/l/${lang}/feed.atom`,
      domService.minifyHTML(`
        <?xml version="1.0" encoding="UTF-8"?>
